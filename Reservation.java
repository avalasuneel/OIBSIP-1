...
public class Reservation
{
    ...
    String trainstations [] ={
        "Assam ","Bihar  ","Gujarat","Odisha ","kerala ","kashmir","Punjab ","Chennai","Tenali ","Agra  "
        };
    ...
    {  
        ...
        int i=0;
        boolean ch= true;
        JOptionPane.showMessageDialog(null,"WELCOME TO ONLINE TRAIN TICKET RESERVATION");
        while(ch==true)
        {
...
public void  login()
{
    ...
    emailid=JOptionPane.showInputDialog("Enter your email_id");  
    password=JOptionPane.showInputDialog("Enter your password ");
    if(!username.equals("&")||emailid.equals("123@gmail.com")||password.equals("12345"))
    {
...
public void trainticket()
{
    ...
    +"============================================================================\n"
    +"S.NO             Train_no              Train_name                  Fares\n"
    +"============================================================================");
    ...
    choices=JOptionPane.showInputDialog("Enter S.NO of the train:");
...
public void cancell()
{
   ...
   String PNR2=JOptionPane.showInputDialog("Enter the PNR Number");
   ...
   if(PNR3==PNR1)
    ...
    {
        JOptionPane.showMessageDialog(null,"PLEASE ENTER THE CORRECT PNR NUMBER");
    }
}
